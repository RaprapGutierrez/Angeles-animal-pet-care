...
const Scalpel = ({ className }) => (
  ...
  >
    ...
    <path d="M9 15l-4.5 4.5a1.5 1.5 0 0 0 2.1 2.1L11 17" />
...
const Microscope = ({ className }) => (
  ...
  >
    ...
    <path d="M12 6V3a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v3" />
  </svg>
);
...
const BRANCHES = [
  {
    id: 1,
    name: "Animal Care Hospital and Wellness Center",
    shortName: "Main Hospital",
    slug: "main-hospital",
    location: "Camachiles, Mabalacat City, Pampanga",
    lat: 15.19361315079041,
    lng: 120.58326675046828,
    region: "Central Luzon",
    type: "Hospital",
    tag: "Flagship Hospital",
    phone: "+63 919-067-5710",
    hours: "Open 24 / 7",
    services: [
      "Emergency Care",
      "Surgery",
  ...
  {
    id: 2,
    name: "Angeles Pet Care Center – Mabiga",
    shortName: "Mabiga",
    slug: "mabiga",
    location: "Mabiga, Mabalacat City, Pampanga",
    lat: 15.208184858641259,
    lng: 120.57906383363806,
    region: "Central Luzon",
    type: "Clinic",
    tag: "Newly Opened",
    phone: "+63 (045) 000-0002",
  ...
  {
    id: 3,
    name: "Angeles Pet Care Center – Friendship",
    shortName: "Friendship",
    slug: "friendship",
    location: "Friendship, Angeles City, Pampanga",
    lat: 15.136652961046165,
    lng: 120.56492647948312,
    region: "Central Luzon",
    type: "Clinic",
    tag: "Main Branch",
    phone: "+63 (045) 000-0003",
    hours: "Mon–Sun · 8AM – 8PM",
    services: ["Consultation", "Grooming", "Vaccination", "Pharmacy"],
    isEmergency: false,
  },
  {
    id: 4,
    name: "Angeles Pet Care Center – Magalang",
    shortName: "Magalang",
    slug: "magalang",
    location: "Magalang, Pampanga",
    lat: 15.222566938150214,
    lng: 120.66177485250144,
    region: "Central Luzon",
    type: "Clinic",
    tag: null,
    phone: "+63 (045) 000-0004",
  ...
  {
    id: 5,
    name: "Angeles Pet Care Center – San Fernando",
    shortName: "San Fernando",
    slug: "san-fernando",
    location: "San Fernando City, Pampanga",
    lat: 15.046763227392159,
    lng: 120.6696952101692,
    region: "Central Luzon",
    type: "Clinic",
    tag: null,
    phone: "+63 (045) 000-0005",
    hours: "Mon–Sun · 8AM – 8PM",
    services: ["Consultation", "Vaccination", "Grooming", "Pharmacy"],
    isEmergency: false,
  },
  {
    id: 6,
    name: "Angeles Pet Care Center – Baguio",
    shortName: "Baguio",
    slug: "baguio",
    location: "Baguio City, Benguet",
    lat: 16.409453078055694,
    lng: 120.60083637951544,
    region: "CAR",
    type: "Clinic",
    tag: null,
    phone: "+63 (074) 000-0006",
    hours: "Mon–Sun · 8AM – 7PM",
    services: ["Consultation", "Vaccination", "Grooming"],
    isEmergency: false,
  },
  {
    id: 7,
    name: "Angeles Pet Care Center – Tarlac",
    shortName: "Tarlac",
    slug: "tarlac",
    location: "Tarlac City, Tarlac",
    lat: 15.474645663508756,
    lng: 120.59270212552384,
    region: "Central Luzon",
    type: "Clinic",
    tag: null,
    phone: "+63 (045) 000-0007",
    hours: "Mon–Sun · 8AM – 7PM",
    services: ["Consultation", "Vaccination", "Grooming"],
    isEmergency: false,
  },
  {
    id: 8,
    name: "Angeles Pet Care Center – Cabanatuan",
    shortName: "Cabanatuan",
    slug: "cabanatuan",
    location: "Cabanatuan City, Nueva Ecija",
    lat: 15.476150781734258,
    lng: 120.9512267371636,
    region: "Central Luzon",
    type: "Clinic",
    tag: null,
    phone: "+63 (044) 000-0008",
    hours: "Mon–Sun · 8AM – 7PM",
    services: ["Consultation", "Vaccination", "Grooming"],
    isEmergency: false,
  },
  {
    id: 9,
    name: "Angeles Pet Care Center – Olongapo",
    shortName: "Olongapo",
    slug: "olongapo",
    location: "Olongapo City, Zambales",
    lat: 14.831106542250787,
    lng: 120.28053506598384,
    region: "Central Luzon",
    type: "Clinic",
    tag: null,
    phone: "+63 (047) 000-0009",
    hours: "Mon–Sun · 8AM – 7PM",
    services: ["Consultation", "Vaccination", "Grooming"],
    isEmergency: false,
  },
  {
    id: 10,
    name: "Angeles Pet Care Center – Sucat",
    shortName: "Sucat",
    slug: "sucat",
    location: "Sucat, Parañaque City, Metro Manila",
    lat: 14.456176379926848,
    lng: 121.03637156412273,
    region: "NCR",
    type: "Clinic",
    tag: null,
    phone: "+63 (02) 000-0010",
    hours: "Mon–Sun · 8AM – 8PM",
    services: ["Consultation", "Vaccination", "Grooming", "Pharmacy"],
    isEmergency: false,
  },
  {
    id: 11,
    name: "Angeles Pet Care Center – Cebu",
    shortName: "Cebu",
    slug: "cebu",
    location: "Cebu City, Cebu",
    lat: 10.385202520525738,
    lng: 123.97519838123732,
    region: "Visayas",
    type: "Clinic",
    tag: null,
    phone: "+63 (032) 000-0011",
    hours: "Mon–Sun · 8AM – 7PM",
    services: ["Consultation", "Vaccination", "Grooming"],
    isEmergency: false,
  },
...
const TRIVIA_ITEMS = [
  {
    ...
    color: "#f59e0b",
    bg: "#fffbeb",
    title: "Dogs have a sense of time",
    body: "Studies show dogs can tell the difference between an hour and five hours. They adjust their excitement based on how long you've been gone.",
  },
  {
    IconComp: Sparkles,
    tag: "Cat Fact",
    color: "#7c3aed",
    bg: "#f5f3ff",
    title: "Cats sleep 12–16 hours a day",
    body: "Cats are crepuscular predators — most active at dawn and dusk. Their long sleep conserves energy for hunting bursts.",
  },
  {
    IconComp: Shield,
    tag: "Dog Health",
    color: "#3d2fa0",
    bg: "#e8e5ff",
    title: "Dental care prevents heart disease",
    body: "Periodontal bacteria in dogs can enter the bloodstream and damage heart valves. Brushing 3× per week reduces risk significantly.",
  },
  {
    ...
    color: "#dc2626",
    bg: "#fef2f2",
    title: "Normal pet temp: 38–39°C",
    body: "A temperature above 39.5°C indicates fever. Above 41°C is a life-threatening emergency requiring immediate care.",
  },
  {
    IconComp: Bone,
    tag: "Nutrition",
    color: "#e11d48",
    bg: "#fff1f2",
    title: "Cooked bones are dangerous",
    body: "Cooked chicken, pork, and fish bones splinter easily and can puncture your pet's digestive tract — a life-threatening emergency.",
  },
];
...
const FAQ_ITEMS = [
  {
    ...
    a: "We offer consultations, vaccinations, grooming, surgery, emergency care, diagnostics, pharmacy, and confinement services depending on the branch.",
  },
  {
    q: "Do I need an appointment?",
    a: "Walk-ins are welcome, but we recommend booking an appointment online or by phone to minimize waiting time.",
  },
  {
    q: "Is the main hospital really open 24/7?",
    a: "Yes! Our Camachiles flagship hospital operates 24 hours a day, 7 days a week for emergencies and urgent care.",
  },
  {
    q: "How do I book an appointment?",
    a: "You can book through our online portal by creating a customer account, or by calling your nearest branch directly.",
  },
  {
    q: "What payment methods are accepted?",
    a: "We accept cash, major credit/debit cards, GCash, and Maya at all branches.",
  },
];
...
const SERVICES = [
  {
    Icon: Stethoscope,
    title: "Consultation",
    desc: "Comprehensive check-ups and expert advice to keep your pet healthy at every stage of life.",
    color: "#3d2fa0",
    bg: "#e8e5ff",
  },
  {
    Icon: Syringe,
    title: "Vaccination",
    desc: "Core and lifestyle vaccines that protect your pet from common, preventable diseases.",
    color: "#f59e0b",
    bg: "#fffbeb",
  },
  {
    Icon: Pill,
    title: "Deworming",
    desc: "Routine parasite control to eliminate intestinal worms and keep your pet's gut healthy.",
    color: "#059669",
    bg: "#ecfdf5",
  },
  {
    Icon: Scalpel,
    title: "Surgery",
    desc: "Minor and major surgical procedures performed safely under expert veterinary care.",
    color: "#dc2626",
    bg: "#fef2f2",
  },
  {
    Icon: ScanIcon,
    title: "Imaging",
    desc: "On-site X-ray, ultrasound, and CT-scan for accurate, fast diagnostic imaging.",
    color: "#2563eb",
    bg: "#eff6ff",
  },
  {
    Icon: Microscope,
    title: "Diagnostic",
    desc: "In-house blood tests, test kits, and PCR testing for precise, timely results.",
    color: "#7c3aed",
    bg: "#f5f3ff",
  },
  {
    Icon: Scissors,
    title: "Grooming",
    desc: "Bathing, trimming, and full grooming services to keep your pet clean and comfortable.",
    color: "#db2777",
    bg: "#fdf2f8",
  },
  {
    Icon: ShoppingBag,
    title: "Pet Shop",
    desc: "Quality food, accessories, and supplies for every pet's everyday needs.",
    color: "#0d9488",
    bg: "#f0fdfa",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        {/* top stripe */}
        <div
          style={{ height: 5, background: isHospital ? T.red : T.primary }}
        />
        ...
        <div style={{ padding: 24 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div
                style={{
                  ...
                  height: 48,
                  borderRadius: 14,
                  background: isHospital ? "#fef2f2" : rc.bg,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <MapPin
                  ...
                  style={{
                    width: 20,
                    height: 20,
                    color: isHospital ? T.red : rc.text,
                  }}
                />
              </div>
              <div>
                <div style={{ display: "flex", gap: 6, marginBottom: 4 }}>
                  <span
                    style={{
                      ...
                      padding: "2px 8px",
                      borderRadius: 4,
                      background: isHospital ? "#fef2f2" : "#e8e5ff",
                      color: isHospital ? T.red : T.primary,
                    }}
                  >
                    {branch.type}
                  </span>
                ...
                >
                  <Icon
                    ...
                    style={{
                      ...
                      marginTop: 2,
                      flexShrink: 0,
                      color: highlight ? T.red : T.primary,
                    }}
                  />
                  <span>{value}</span>
                </div>
          ...
          >
            ...
            >
              <MapIcon className="" style={{ width: 14, height: 14 }} />{" "}
              Directions
            </a>
            <a
            ...
            >
              <Phone className="" style={{ width: 14, height: 14 }} /> Call
              Branch
            </a>
          </div>
        </div>
    ...
    <div
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.filter =
          "drop-shadow(0 12px 28px rgba(61,47,160,.25))";
      }}
      onMouseLeave={(e) => {
    ...
    >
      <div className="flip-inner" style={{ height: "100%" }}>
        ...
        <article
          ...
          style={{
            border: `1px solid ${isHospital ? "#fca5a5" : T.border}`,
            display: "flex",
        ...
        >
          <div
            style={{
              height: 4,
              background: isHospital ? T.red : T.primary,
              flexShrink: 0,
            }}
          />
          <div
          ...
          >
            ...
            >
              {[
                ...
                },
                {
                  ...
                  value: branch.hours,
                  color: isHospital ? T.red : T.primary,
                  textColor: isHospital ? T.red : T.mutedFg,
                  bold: isHospital,
                },
                {
                  Icon: Phone,
            ...
            >
              ...
              {branch.services.length > 3 && (
                <span
                  style={{ fontSize: 10, fontWeight: 700, color: T.primary }}
                >
            ...
            >
              <p style={{ fontSize: 11, color: T.mutedFg, opacity: 0.6 }}>
...
function SkeletonCard() {
  return (
    ...
    >
      ...
      <div
        className="skeleton"
        style={{ height: 22, width: "75%", marginBottom: 8 }}
      />
      <div
        className="skeleton"
        style={{ height: 18, width: 90, marginBottom: 14 }}
      />
      {[1, 2, 3].map((i) => (
  ...
  return (
    <header
      ...
      style={{
        ...
        right: scrolled ? undefined : 0,
        width: scrolled ? undefined : "100%",
        maxWidth: scrolled ? "1100px" : "100%",
        margin: scrolled ? "0 auto" : "0",
        transition: "top .3s, max-width .3s, border-radius .3s, margin .3s",
      }}
    >
      <div
        style={{
          ...
          borderBottom: scrolled
            ...
            : `1px solid ${T.border}`,
          boxShadow: scrolled
            ? "0 8px 40px rgba(61,47,160,.12)"
            : "0 4px 20px rgba(61,47,160,.07)",
          position: "relative",
          ...
          >
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "emergency" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
            ...
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "branches" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
                background: "transparent",
                border: "none",
            ...
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "services" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
                background: "transparent",
                border: "none",
            ...
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "ai" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
                background: "transparent",
                border: "none",
            ...
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "pet-health" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
                background: "transparent",
                border: "none",
            ...
            <button
              ...
              style={{
                fontSize: 13,
                fontWeight: 500,
                color: activeSection === "faq" ? T.primary : T.mutedFg,
                padding: "7px 14px",
                borderRadius: 9,
                background: "transparent",
                border: "none",
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(180deg, rgba(15,23,42,0) 0%, rgba(15,23,42,0.6) 75%, #0f172a 100%)",
          pointerEvents: "none",
        }}
      />
      {/* decorative circles */}
      ...
      >
        ...
        >
          Angeles Pet Care is renowned for its commitment to innovation and
          excellence in veterinary medicine. 10 Veterinary Clinics and 1
          Veterinary Hospital, all committed to delivering advanced care,
          trusted expertise, and compassionate service.
        </p>
            ...
            {stats.map((s) => (
              <div
                ...
                style={{
                  ...
                  textAlign: "center",
                  boxShadow:
                    "0 8px 32px rgba(0,0,0,.2), inset 0 1px 0 rgba(255,255,255,.6)",
                  border: "1px solid rgba(255,255,255,.4)",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ color: "#fff" }}>
              ...
              >
                Main Hospital in Camachiles is open 24/7
              </div>
            </div>
          </div>
          <button
      ...
      >
        <img
          ...
          style={{
            ...
            animation: "floatUp 3.5s ease-in-out infinite .6s",
          }}
        />
        <img
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            From routine checkups to advanced diagnostics, every branch is
            equipped to care for your pet at every stage.
          </p>
        </div>
          ...
          {SERVICES.map((s, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 16px 36px rgba(0,0,0,.3)";
...
function AISection() {
  ...
  const messages = [
    {
      role: "bot",
      text: "Hi! I'm SeraphVet AI. Describe your pet's symptoms and I'll help you understand what might be going on.",
    },
    {
      role: "user",
      text: "My dog has been vomiting and seems very tired since this morning.",
    },
    {
      role: "bot",
      text: "I understand your concern. Vomiting combined with lethargy can have several causes. Can you tell me if your dog has eaten anything unusual?",
    },
  ];
  ...
  return (
    <section
      id="ai"
      className="dark-section"
      style={{ color: "#fff", paddingTop: 100, paddingBottom: 100 }}
    >
      <div className="radial-glow" />
      <div
        style={{
      ...
      >
        ...
        <div className="slide-up">
          ...
          >
            Our AI assistant helps you understand what your pet might be
            experiencing — from minor issues to signs that need urgent
          ...
          {[
            {
              ...
              desc: "Our AI identifies patterns across hundreds of conditions",
            },
            {
              title: "Instant Guidance",
              desc: "Get immediate triage advice for home or vet care",
            },
            {
              title: "No Account Needed",
              desc: "Ask as a guest anytime — free and instant",
            },
          ].map((f, i) => (
            <div
              key={i}
            ...
            >
              ...
              >
                <Sparkles
                  className=""
                  style={{ width: 14, height: 14, color: T.accent }}
                />
              </div>
              <div>
                <div style={{ fontWeight: 600, fontSize: 14 }}>{f.title}</div>
                <div style={{ fontSize: 13, opacity: 0.6 }}>{f.desc}</div>
              </div>
            </div>
          ))}
          ...
          >
            ...
            >
              <Sparkles className="" style={{ width: 15, height: 15 }} /> Ask AI
              About My Pet
            </button>
            <button
              className="pill"
          ...
          >
            ...
            AI guidance is informational only — always consult a licensed
            veterinarian.
          </p>
        </div>
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        msg.role === "bot" ? T.primary : "rgba(255,255,255,.1)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 13,
                    ...
                    style={{
                      ...
                      background:
                        msg.role === "bot"
                          ? `${T.primary}33`
                          : "rgba(255,255,255,.1)",
                      border: `1px solid ${msg.role === "bot" ? `${T.primary}44` : "rgba(255,255,255,.15)"}`,
                    }}
                  >
                    {msg.text}
                  </div>
          ...
          >
            <div
              style={{
                ...
                color: "#4ade80",
                fontFamily: "'Poetsen One', sans-serif",
                WebkitTextStroke: "1px rgba(74,222,128,.4)",
                paintOrder: "stroke fill",
              }}
            >
              24/7
    ...
    tabs: [
      {
        ...
        content: `The dog (Canis lupus familiaris) is a domesticated mammal known for its loyalty, intelligence, and companionship. Dogs have been living alongside humans for thousands of years and are often considered one of the most versatile pets. Depending on the breed, a dog's lifespan typically ranges from 10 to 15 years, and their size can vary from very small to very large.`,
      },
      {
        title: "Dog Breeds",
        content: `Common dog breeds include:\n• Golden Retriever\n• Labrador Retriever\n• German Shepherd\n• Siberian Husky\n• Pomeranian\n• Shih Tzu\n• Beagle`,
      },
      {
        title: "Health & Diseases",
        content: `Dogs can experience various health conditions throughout their lives. Regular veterinary checkups, vaccinations, and proper nutrition help prevent many illnesses. Watch for: vomiting, diarrhea, loss of appetite, coughing, or unusual lethargy.\n\nCommon Diseases:\n• Rabies\n• Parvovirus\n• Distemper\n• Heartworm Disease\n• Tick Infestation`,
      },
      {
        title: "Vaccination & Care",
        content: `Puppies require a series of vaccines during their first months, followed by booster shots. Regular grooming, dental care, exercise, and parasite prevention are essential.\n\nRecommended Vaccines:\n• Anti-Rabies Vaccine\n• 5-in-1 Vaccine\n• 8-in-1 Vaccine\n• Kennel Cough Vaccine`,
      },
      {
        title: "Nutrition & Feeding",
        content: `A balanced diet is necessary for growth, energy, and immune health. Dogs require proteins, fats, vitamins, and minerals.\n\nRecommended Foods:\n• High-quality dog food\n• Cooked chicken\n• Cooked fish\n• Rice, vegetables, eggs\n\nFoods to Avoid:\n• Chocolate\n• Grapes & Raisins\n• Onions & Garlic\n• Alcohol`,
      },
      {
        title: "Behavior & Facts",
        content: `Dogs are social animals that communicate through body language, vocalizations, and facial expressions. They can learn commands and form strong bonds with their owners.\n\nInteresting Facts:\n• Dogs have an exceptional sense of smell\n• Can understand dozens of words and commands\n• Puppies are born deaf and blind\n• Use tail movements to express emotions\n• Some dogs assist people with disabilities`,
      },
    ],
  },
  cat: {
    ...
    tabs: [
      {
        title: "Basic Information",
        content: `The domestic cat (Felis catus) is a small carnivorous mammal that has been a companion to humans for thousands of years. Cats are known for their independence, agility, curiosity, and affectionate nature. They typically live between 12 and 18 years with proper care.`,
      },
      {
        title: "Cat Breeds",
        content: `Common cat breeds include:\n• Persian\n• Siamese\n• Maine Coon\n• Bengal\n• British Shorthair\n• Ragdoll\n• Scottish Fold\n• Sphynx\n• American Shorthair\n• Russian Blue`,
      },
      {
        title: "Health & Diseases",
        content: `Cats can develop illnesses caused by viruses, bacteria, parasites, genetics, or aging. Monitor for: loss of appetite, vomiting, diarrhea, excessive sleeping, or sudden behavior changes.\n\nCommon Diseases:\n• Rabies\n• Feline Upper Respiratory Infection\n• Feline Leukemia (FeLV)\n• Feline Immunodeficiency Virus (FIV)\n• Flea Infestation\n• Kidney Disease`,
      },
      {
        title: "Vaccination & Care",
        content: `Kittens require a series of vaccines during their first few months, followed by booster vaccinations throughout adulthood.\n\nRecommended Vaccines:\n• Rabies Vaccine\n• FVRCP Vaccine\n• FeLV Vaccine\n\nBasic Care:\n• Regular brushing & nail trimming\n• Ear cleaning & dental care\n• Deworming\n• Annual health checkups`,
      },
      {
        title: "Nutrition & Feeding",
        content: `Cats are obligate carnivores requiring nutrients found in animal-based proteins. Fresh water should always be available.\n\nRecommended Foods:\n• High-quality cat food\n• Cooked chicken & fish\n• Wet cat food\n• Cooked eggs\n\nFoods to Avoid:\n• Chocolate\n• Onions & Garlic\n• Grapes & Raisins\n• Alcohol & Caffeine\n• Raw bones`,
      },
      {
        title: "Behavior & Facts",
        content: `Cats communicate through vocalizations, body posture, and tail movements. They are naturally curious and form strong bonds with their owners.\n\nInteresting Facts:\n• Cats sleep 12–16 hours each day\n• Each cat's nose print is unique\n• Cats can jump several times their own height\n• Whiskers help navigate tight spaces\n• Purring can signal comfort and healing`,
      },
    ],
  },
};
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: iconColor,
                    boxShadow: active
                      ? `0 6px 22px ${PET_DATA[p].accent}55`
                      : "none",
                    transition: "all .25s cubic-bezier(.4,0,.2,1)",
                  }}
                >
                  {p === "dog" ? (
                    <DogIcon size={16} color={iconColor} />
                  ) : (
                    <CatIcon size={16} color={iconColor} />
                  )}
                  {p === "dog" ? "Dogs" : "Cats"}
                </button>
              );
                ...
                {reviews.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      background:
                        active === i ? T.amber : "rgba(255,255,255,.25)",
...
function FAQSection({ faqRef }) {
  ...
  return (
    <section
      ref={faqRef}
      id="faq"
      style={{ padding: "80px 0", background: "#f3f0ff" }}
    >
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: T.mutedFg, fontSize: 15 }}>
            Quick answers to common questions about Angeles Animal Care
            Hospital.
          </p>
        </div>
...
function Footer({ onRegionClick }) {
  ...
  return (
    <footer
      style={{ background: "#0f172a", color: "#fff", position: "relative" }}
    >
      <div className="radial-glow" />
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 24px" }}>
        ...
        >
          ...
          <div className="slide-up" style={{ gridColumn: "span 1" }}>
            ...
            >
              Providing compassionate veterinary care to pets across the
            ...
            <div>
              ...
              <a
                ...
                style={{
                  ...
                  flexShrink: 0,
                  boxShadow: "0 2px 8px rgba(24,119,242,.4)",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-2px)";
                  e.currentTarget.style.boxShadow =
                    "0 4px 14px rgba(24,119,242,.6)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0)";
                  e.currentTarget.style.boxShadow =
                    "0 2px 8px rgba(24,119,242,.4)";
                }}
              >
          ...
          <div>
            ...
            >
              ...
              <p style={{ opacity: 0.6 }}>
                Camachiles, Mabalacat City, Pampanga
              </p>
              <p style={{ opacity: 0.6 }}>wellness.apcc@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <p style={{ fontSize: 12, opacity: 0.5, margin: 0 }}>
              © {new Date().getFullYear()} Angeles Animal Care Hospital. All
              rights reserved.
            </p>
          </div>
  ...
  const filtered = useMemo(
    () =>
      BRANCHES.filter((b) => {
        const matchQ =
          !q ||
          (b.name + b.location + b.region + b.services.join(" "))
            .toLowerCase()
      ...
      <FixedPortal>
        <button
          ...
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            boxShadow: "0 4px 20px rgba(61,47,160,.4)",
            cursor: "pointer",
            opacity: scrolled ? 1 : 0,
            transform: scrolled
              ? "translateY(0) scale(1)"
              : "translateY(12px) scale(.85)",
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ color: T.mutedFg, fontSize: 15 }}>
                Filter by region or facility type to locate your nearest Angeles
                Pet Care location.
              </p>
            </div>
          ...
          <div
            ...
            style={{
              ...
              gap: 16,
              marginBottom: 32,
              boxShadow: "0 2px 12px rgba(61,47,160,.06)",
            }}
          >
              ...
              {filtered.map((b, i) => (
                ...
                >
                  <BranchCard
                    branch={b}
                    index={i}
                    onViewDetail={setSelectedBranch}
                  />
                </div>
              ))}
            </div>
